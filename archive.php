            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                    <div class="archive-posts-area bg-white p-30 mb-30 box-shadow">
                        ...
                        <?php
                                $no=1;
                                $query=mysqli_query($k,"SELECT * FROM artikel order by id_artikel");
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img background-image" style="background-image: url(img/gambar/<?= $var['gambar']; ?>)";">
                            </div>
